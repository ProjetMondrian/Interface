...
if not autoAdjustNbrOfColors:
    desiredNbrOfColors = int(sys.argv[2])
else:
    ...
    for y in range(0,coeff2):
        ...
        if printTimeInfo:
            if(x==0 and y==0):
                ...
                time2=time.clock()
            print(' '*18 + 'Estimated time remaining:' + int(timeRemaining) + 'seconds' + ' '*5 + '\r')
            progress += 1/2.56
            print(' Splitting: '+str(int(progress))+'%'+' '*4 + '\r')
...
for x in range(0,coeff2):
    for y in range(0,coeff2):
        ...
        if printTimeInfo:
            ...
            print(' '*18 + 'Estimated time remaining:' + int(timeRemaining) + 'seconds' + ' '*5 + '\r')
            progress += 1/2.56
            print(' Merging: '+str(int(progress))+'%'+' '*4 + '\r')
